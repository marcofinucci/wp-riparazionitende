 ...
 */
const fontScale = {
  "5xl": "leading-[1.1] text-[2.25rem] md:text-[3rem] lg:text-[3.75rem]",
  "4xl": "leading-[1.15] text-[1.875rem] md:text-[2.25rem] lg:text-[3rem]",
  "3xl": "leading-[1.2] text-[1.875rem] md:text-[2.25rem]",
