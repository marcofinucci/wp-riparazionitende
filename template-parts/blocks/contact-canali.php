...
<section class="block-contact-canali <?php echo esc_attr($margin_top_class); ?>">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <a href="<?php echo esc_url($wa_url); ?>" target="_blank" rel="noopener noreferrer" class="bg-cream rounded-2xl p-6 border border-canvas-dark/30 hover:border-olive/40 hover:shadow-lg transition-all duration-300 flex flex-col gap-4 group cursor-pointer">
        ...
        <div>
          ...
          <span class="inline-flex items-center gap-1.5 text-forest group-hover:text-olive font-heading font-medium type-sm transition-colors">
            Scrivici ora
      ...
      <a href="<?php echo esc_url('mailto:' . $email); ?>" class="bg-cream rounded-2xl p-6 border border-canvas-dark/30 hover:border-olive/40 hover:shadow-lg transition-all duration-300 flex flex-col gap-4 group cursor-pointer">
        <div class="w-12 h-12 rounded-xl bg-forest/10 flex items-center justify-center">
        ...
        <div>
          ...
          <span class="text-forest group-hover:text-olive font-heading font-medium type-sm transition-colors break-all"><?php echo esc_html($email); ?></span>
        </div>
      </a>

      <a href="<?php echo esc_url(rtc_phone_link($phone)); ?>" class="bg-cream rounded-2xl p-6 border border-canvas-dark/30 hover:border-olive/40 hover:shadow-lg transition-all duration-300 flex flex-col gap-4 group cursor-pointer">
        ...
        <div>
          ...
          <span class="text-forest group-hover:text-olive font-heading font-medium type-sm transition-colors"><?php echo esc_html($phone); ?></span>
        </div>
      </a>
    </div>
