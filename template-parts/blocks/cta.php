...
<section class="block-cta relative overflow-hidden bg-forest-dark py-14 lg:py-16 <?php echo esc_attr($margin_top_class); ?>">
  ...
  <div class="reveal max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 flow">
    <?php if ($title) : ?>
    ...
    <?php endif; ?>
    <?php if ($text) : ?>
      <p class="text-white/65 max-w-lg mx-auto mt-4 rich-text"><?php echo wp_kses_post($text); ?></p>
    <?php endif; ?>
    <?php if (!empty($link_primary['url']) || !empty($link_secondary['url'])) : ?>
      <div class="flex flex-col items-center sm:flex-row gap-4 justify-center mt-6">
